...
const FurnitureDetail = ({ route,navigation }) => {
  ...
  const [reviewsCount, setReviewsCount] = useState(67);
...
useEffect(() => {
  ...
  return (
    ...
    <ScrollView style={{  backgroundColor: '#fff', padding: 20 }}>
      ...
      <Text style={{ fontSize: 16, marginBottom: 5 }}>• Kích thước: {product.dimensions}</Text>
      <Text style={{ fontSize: 16, marginBottom: 5 }}>• Xuất xứ: {product.origin}</Text>
